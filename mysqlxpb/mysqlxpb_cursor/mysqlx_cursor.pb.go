...
package mysqlxpb_cursor

import (
	proto "github.com/golang/protobuf/proto"
	_ "github.com/ldeng7/go-mysqlx-client/mysqlxpb"
	mysqlxpb_prepare "github.com/ldeng7/go-mysqlx-client/mysqlxpb/mysqlxpb_prepare"
...
type Open_OneOfMessage struct {
	...
	PrepareExecute *mysqlxpb_prepare.Execute `protobuf:"bytes,2,opt,name=prepare_execute,json=prepareExecute" json:"prepare_execute,omitempty"`
}
...
func (x *Open_OneOfMessage) GetPrepareExecute() *mysqlxpb_prepare.Execute {
	if x != nil {
...
var file_mysqlx_cursor_proto_rawDesc = []byte{
	...
	0x73, 0x6f, 0x72, 0x49, 0x64, 0x3a, 0x04, 0x88, 0xea, 0x30, 0x2c, 0x42, 0x66, 0x0a, 0x17, 0x63,
	0x6f, 0x6d, 0x2e, 0x6d, 0x79, 0x73, 0x71, 0x6c, 0x2e, 0x63, 0x6a, 0x2e, 0x78, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x5a, 0x4b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	...
	0x78, 0x70, 0x62, 0x2f, 0x6d, 0x79, 0x73, 0x71, 0x6c, 0x78, 0x70, 0x62, 0x5f, 0x63, 0x75, 0x72,
	0x73, 0x6f, 0x72, 0x3b, 0x6d, 0x79, 0x73, 0x71, 0x6c, 0x78, 0x70, 0x62, 0x5f, 0x63, 0x75, 0x72,
	0x73, 0x6f, 0x72,
}
...
var file_mysqlx_cursor_proto_goTypes = []interface{}{
	...
	(*mysqlxpb_prepare.Execute)(nil), // 5: Mysqlx.Prepare.Execute
}
