...
type SessionVariableChanged struct {
	...
	Value *mysqlxpb_datatypes.Scalar `protobuf:"bytes,2,opt,name=value" json:"value,omitempty"`
}
...
func (x *SessionVariableChanged) GetValue() *mysqlxpb_datatypes.Scalar {
	if x != nil {
		return x.Value
	}
	return nil
...
type SessionStateChanged struct {
	...
	//* updated value
	Value []*mysqlxpb_datatypes.Scalar `protobuf:"bytes,2,rep,name=value" json:"value,omitempty"`
}
...
func (x *SessionStateChanged) GetValue() []*mysqlxpb_datatypes.Scalar {
	if x != nil {
		return x.Value
	}
	return nil
...
var file_mysqlx_notice_proto_rawDesc = []byte{
	...
	0x6c, 0x6f, 0x42, 0x66, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x79, 0x73, 0x71, 0x6c, 0x2e,
	0x63, 0x6a, 0x2e, 0x78, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x5a, 0x4b, 0x67,
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6c, 0x64, 0x65, 0x6e, 0x67, 0x37,
	0x2f, 0x67, 0x6f, 0x2d, 0x6d, 0x79, 0x73, 0x71, 0x6c, 0x78, 0x2d, 0x63, 0x6c, 0x69, 0x65, 0x6e,
	0x74, 0x2f, 0x6d, 0x79, 0x73, 0x71, 0x6c, 0x78, 0x70, 0x62, 0x2f, 0x6d, 0x79, 0x73, 0x71, 0x6c,
	0x78, 0x70, 0x62, 0x5f, 0x6e, 0x6f, 0x74, 0x69, 0x63, 0x65, 0x3b, 0x6d, 0x79, 0x73, 0x71, 0x6c,
	0x78, 0x70, 0x62, 0x5f, 0x6e, 0x6f, 0x74, 0x69, 0x63, 0x65,
}
...
var file_mysqlx_notice_proto_goTypes = []interface{}{
	...
	(*mysqlxpb_datatypes.Scalar)(nil),      // 11: Mysqlx.Datatypes.Scalar
}
