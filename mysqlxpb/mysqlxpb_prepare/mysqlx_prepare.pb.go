...
package mysqlxpb_prepare

import (
	proto "github.com/golang/protobuf/proto"
	_ "github.com/ldeng7/go-mysqlx-client/mysqlxpb"
	mysqlxpb_crud "github.com/ldeng7/go-mysqlx-client/mysqlxpb/mysqlxpb_crud"
	mysqlxpb_datatypes "github.com/ldeng7/go-mysqlx-client/mysqlxpb/mysqlxpb_datatypes"
	mysqlxpb_sql "github.com/ldeng7/go-mysqlx-client/mysqlxpb/mysqlxpb_sql"
...
type Execute struct {
	...
	Args []*mysqlxpb_datatypes.Any `protobuf:"bytes,2,rep,name=args" json:"args,omitempty"`
...
func (x *Execute) GetArgs() []*mysqlxpb_datatypes.Any {
	if x != nil {
		return x.Args
	}
	return nil
...
type Prepare_OneOfMessage struct {
	...
	Find        *mysqlxpb_crud.Find        `protobuf:"bytes,2,opt,name=find" json:"find,omitempty"`
	Insert      *mysqlxpb_crud.Insert      `protobuf:"bytes,3,opt,name=insert" json:"insert,omitempty"`
	Update      *mysqlxpb_crud.Update      `protobuf:"bytes,4,opt,name=update" json:"update,omitempty"`
	Delete      *mysqlxpb_crud.Delete      `protobuf:"bytes,5,opt,name=delete" json:"delete,omitempty"`
	StmtExecute *mysqlxpb_sql.StmtExecute  `protobuf:"bytes,6,opt,name=stmt_execute,json=stmtExecute" json:"stmt_execute,omitempty"`
}
...
func (x *Prepare_OneOfMessage) GetFind() *mysqlxpb_crud.Find {
	if x != nil {
		return x.Find
	}
	return nil
...
func (x *Prepare_OneOfMessage) GetInsert() *mysqlxpb_crud.Insert {
	if x != nil {
		return x.Insert
	}
	return nil
...
func (x *Prepare_OneOfMessage) GetUpdate() *mysqlxpb_crud.Update {
	if x != nil {
		return x.Update
	}
	return nil
...
func (x *Prepare_OneOfMessage) GetDelete() *mysqlxpb_crud.Delete {
	if x != nil {
		return x.Delete
	}
	return nil
...
func (x *Prepare_OneOfMessage) GetStmtExecute() *mysqlxpb_sql.StmtExecute {
	if x != nil {
...
var file_mysqlx_prepare_proto_rawDesc = []byte{
	...
	0x04, 0x88, 0xea, 0x30, 0x2a, 0x42, 0x68, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x79, 0x73,
	0x71, 0x6c, 0x2e, 0x63, 0x6a, 0x2e, 0x78, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
	0x5a, 0x4d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6c, 0x64, 0x65,
	0x6e, 0x67, 0x37, 0x2f, 0x67, 0x6f, 0x2d, 0x6d, 0x79, 0x73, 0x71, 0x6c, 0x78, 0x2d, 0x63, 0x6c,
	0x69, 0x65, 0x6e, 0x74, 0x2f, 0x6d, 0x79, 0x73, 0x71, 0x6c, 0x78, 0x70, 0x62, 0x2f, 0x6d, 0x79,
	0x73, 0x71, 0x6c, 0x78, 0x70, 0x62, 0x5f, 0x70, 0x72, 0x65, 0x70, 0x61, 0x72, 0x65, 0x3b, 0x6d,
	0x79, 0x73, 0x71, 0x6c, 0x78, 0x70, 0x62, 0x5f, 0x70, 0x72, 0x65, 0x70, 0x61, 0x72, 0x65,
}
...
var file_mysqlx_prepare_proto_goTypes = []interface{}{
	...
	(*mysqlxpb_datatypes.Any)(nil),   // 5: Mysqlx.Datatypes.Any
	(*mysqlxpb_crud.Find)(nil),       // 6: Mysqlx.Crud.Find
	(*mysqlxpb_crud.Insert)(nil),     // 7: Mysqlx.Crud.Insert
	(*mysqlxpb_crud.Update)(nil),     // 8: Mysqlx.Crud.Update
	(*mysqlxpb_crud.Delete)(nil),     // 9: Mysqlx.Crud.Delete
	(*mysqlxpb_sql.StmtExecute)(nil), // 10: Mysqlx.Sql.StmtExecute
}
